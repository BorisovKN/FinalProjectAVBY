...
public class MainPage extends BasePage {
    private static final Label PAGE_LOCATOR = new Label(By.xpath("//a[@class='header_logo-wrap']"));
    private static final By pageLocator = By.xpath("//a[@class='header_logo-wrap']");
